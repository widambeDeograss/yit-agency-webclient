            ...
            <div className="h-full p-8 text-white">
              <div className="relative h-full flex flex-col justify-between">
                <h2 className="text-3xl font-bold">
                  Join 5,000+ Tech Enthusiasts
                </h2>
                <div className="space-y-6">
                  <p className="text-xl leading-relaxed">
                    Collaborate, learn and grow with Africa's fastest-growing
                    tech community
                  </p>
                  <div className="flex gap-3">
                    {[1, 2, 3].map((_, i) => (
                      <div
                        key={i}
                        className="w-14 h-14 bg-white/10 rounded-lg backdrop-blur-sm"
                      />
                    ))}
                  </div>
                </div>
                ...
                <>
                  ...
                  <h3 className="text-3xl font-bold">Welcome to YIT</h3>
                    <p className="text-lg text-muted-foreground">
                      Join the largest tech community in East Africa
                    </p>
                  </div>
